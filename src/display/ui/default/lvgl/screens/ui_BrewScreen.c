...
ui_object_set_themeable_style_property(ui_BrewScreen_tempTarget, LV_PART_MAIN| LV_STATE_DEFAULT, LV_STYLE_IMG_RECOLOR, _ui_theme_color_NiceWhite);
ui_object_set_themeable_style_property(ui_BrewScreen_tempTarget, LV_PART_MAIN| LV_STATE_DEFAULT, LV_STYLE_IMG_RECOLOR_OPA, _ui_theme_alpha_NiceWhite);
...
ui_object_set_themeable_style_property(ui_BrewScreen_startButton, LV_PART_MAIN| LV_STATE_DEFAULT, LV_STYLE_OUTLINE_COLOR, _ui_theme_color_Dark);
ui_object_set_themeable_style_property(ui_BrewScreen_startButton, LV_PART_MAIN| LV_STATE_DEFAULT, LV_STYLE_OUTLINE_OPA, _ui_theme_alpha_Dark);
...
ui_object_set_themeable_style_property(ui_BrewScreen_tempText, LV_PART_MAIN| LV_STATE_DEFAULT, LV_STYLE_BG_COLOR, _ui_theme_color_Dark);
ui_object_set_themeable_style_property(ui_BrewScreen_tempText, LV_PART_MAIN| LV_STATE_DEFAULT, LV_STYLE_BG_OPA, _ui_theme_alpha_Dark);
...
ui_BrewScreen_controlContainer = lv_obj_create(ui_BrewScreen);
...
ui_object_set_themeable_style_property(ui_BrewScreen_modeSwitch, LV_PART_MAIN| LV_STATE_DEFAULT, LV_STYLE_BG_COLOR, _ui_theme_color_NiceWhite);
ui_object_set_themeable_style_property(ui_BrewScreen_modeSwitch, LV_PART_MAIN| LV_STATE_DEFAULT, LV_STYLE_BG_OPA, _ui_theme_alpha_NiceWhite);
ui_object_set_themeable_style_property(ui_BrewScreen_modeSwitch, LV_PART_MAIN| LV_STATE_DEFAULT, LV_STYLE_BG_GRAD_COLOR, _ui_theme_color_Dark);
...
ui_object_set_themeable_style_property(ui_BrewScreen_timedButton, LV_PART_MAIN| LV_STATE_DEFAULT, LV_STYLE_BG_IMG_RECOLOR, _ui_theme_color_Dark);
ui_object_set_themeable_style_property(ui_BrewScreen_timedButton, LV_PART_MAIN| LV_STATE_DEFAULT, LV_STYLE_BG_IMG_RECOLOR_OPA, _ui_theme_alpha_Dark);
...
ui_object_set_themeable_style_property(ui_BrewScreen_volumetricButton, LV_PART_MAIN| LV_STATE_DEFAULT, LV_STYLE_BG_IMG_RECOLOR, _ui_theme_color_NiceWhite);
ui_object_set_themeable_style_property(ui_BrewScreen_volumetricButton, LV_PART_MAIN| LV_STATE_DEFAULT, LV_STYLE_BG_IMG_RECOLOR_OPA, _ui_theme_alpha_NiceWhite);
...
ui_BrewScreen_tempContainer = lv_obj_create(ui_BrewScreen_controlContainer);
...
ui_BrewScreen_targetContainer = lv_obj_create(ui_BrewScreen_controlContainer);
