...
ui_object_set_themeable_style_property(ui_StatusScreen_contentPanel2, LV_PART_MAIN| LV_STATE_DEFAULT, LV_STYLE_BORDER_COLOR, _ui_theme_color_NiceWhite);
ui_object_set_themeable_style_property(ui_StatusScreen_contentPanel2, LV_PART_MAIN| LV_STATE_DEFAULT, LV_STYLE_BORDER_OPA, _ui_theme_alpha_NiceWhite);
...
ui_object_set_themeable_style_property(ui_StatusScreen_pauseButton, LV_PART_MAIN| LV_STATE_DEFAULT, LV_STYLE_OUTLINE_COLOR, _ui_theme_color_Dark);
ui_object_set_themeable_style_property(ui_StatusScreen_pauseButton, LV_PART_MAIN| LV_STATE_DEFAULT, LV_STYLE_OUTLINE_OPA, _ui_theme_alpha_Dark);
...
ui_object_set_themeable_style_property(ui_StatusScreen_preinfusePumpBar, LV_PART_MAIN| LV_STATE_DEFAULT, LV_STYLE_BG_COLOR, _ui_theme_color_SemiDark);
ui_object_set_themeable_style_property(ui_StatusScreen_preinfusePumpBar, LV_PART_MAIN| LV_STATE_DEFAULT, LV_STYLE_BG_OPA, _ui_theme_alpha_SemiDark);

ui_object_set_themeable_style_property(ui_StatusScreen_preinfusePumpBar, LV_PART_INDICATOR| LV_STATE_DEFAULT, LV_STYLE_BG_COLOR, _ui_theme_color_Progress);
ui_object_set_themeable_style_property(ui_StatusScreen_preinfusePumpBar, LV_PART_INDICATOR| LV_STATE_DEFAULT, LV_STYLE_BG_OPA, _ui_theme_alpha_Progress);
...
ui_object_set_themeable_style_property(ui_StatusScreen_preinfuseBloomBar, LV_PART_MAIN| LV_STATE_DEFAULT, LV_STYLE_BG_COLOR, _ui_theme_color_SemiDark);
ui_object_set_themeable_style_property(ui_StatusScreen_preinfuseBloomBar, LV_PART_MAIN| LV_STATE_DEFAULT, LV_STYLE_BG_OPA, _ui_theme_alpha_SemiDark);

ui_object_set_themeable_style_property(ui_StatusScreen_preinfuseBloomBar, LV_PART_INDICATOR| LV_STATE_DEFAULT, LV_STYLE_BG_COLOR, _ui_theme_color_Progress);
ui_object_set_themeable_style_property(ui_StatusScreen_preinfuseBloomBar, LV_PART_INDICATOR| LV_STATE_DEFAULT, LV_STYLE_BG_OPA, _ui_theme_alpha_Progress);
...
ui_object_set_themeable_style_property(ui_StatusScreen_preinfusePumpLabel, LV_PART_MAIN| LV_STATE_DEFAULT, LV_STYLE_TEXT_COLOR, _ui_theme_color_SemiDark);
ui_object_set_themeable_style_property(ui_StatusScreen_preinfusePumpLabel, LV_PART_MAIN| LV_STATE_DEFAULT, LV_STYLE_TEXT_OPA, _ui_theme_alpha_SemiDark);
...
ui_object_set_themeable_style_property(ui_StatusScreen_preinfuseBloomLabel, LV_PART_MAIN| LV_STATE_DEFAULT, LV_STYLE_TEXT_COLOR, _ui_theme_color_SemiDark);
ui_object_set_themeable_style_property(ui_StatusScreen_preinfuseBloomLabel, LV_PART_MAIN| LV_STATE_DEFAULT, LV_STYLE_TEXT_OPA, _ui_theme_alpha_SemiDark);
...
ui_StatusScreen_tempTarget= NULL;
ui_StatusScreen_tempGauge= NULL;
ui_StatusScreen_ImgButton3= NULL;
...
ui_StatusScreen_preinfusePumpBar= NULL;
ui_StatusScreen_preinfuseBloomBar= NULL;
ui_StatusScreen_brewBar= NULL;
ui_StatusScreen_labelContainer= NULL;
ui_StatusScreen_preinfusePumpLabel= NULL;
ui_StatusScreen_preinfuseBloomLabel= NULL;
ui_StatusScreen_brewLabel= NULL;
ui_StatusScreen_brewVolume= NULL;
ui_StatusScreen_tempText= NULL;
