...
ui_object_set_themeable_style_property(ui_ProfileScreen_tempTarget, LV_PART_MAIN| LV_STATE_DEFAULT, LV_STYLE_IMG_RECOLOR, _ui_theme_color_NiceWhite);
ui_object_set_themeable_style_property(ui_ProfileScreen_tempTarget, LV_PART_MAIN| LV_STATE_DEFAULT, LV_STYLE_IMG_RECOLOR_OPA, _ui_theme_alpha_NiceWhite);
...
lv_obj_set_style_bg_color(ui_ProfileScreen_profileChoices, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT );
lv_obj_set_style_bg_opa(ui_ProfileScreen_profileChoices, 0, LV_PART_MAIN| LV_STATE_DEFAULT);
...
ui_object_set_themeable_style_property(ui_ProfileScreen_tempText, LV_PART_MAIN| LV_STATE_DEFAULT, LV_STYLE_TEXT_COLOR, _ui_theme_color_NiceWhite);
ui_object_set_themeable_style_property(ui_ProfileScreen_tempText, LV_PART_MAIN| LV_STATE_DEFAULT, LV_STYLE_TEXT_OPA, _ui_theme_alpha_NiceWhite);
lv_obj_set_style_text_font(ui_ProfileScreen_tempText, &lv_font_montserrat_24, LV_PART_MAIN| LV_STATE_DEFAULT);
ui_object_set_themeable_style_property(ui_ProfileScreen_tempText, LV_PART_MAIN| LV_STATE_DEFAULT, LV_STYLE_BG_COLOR, _ui_theme_color_Dark);
ui_object_set_themeable_style_property(ui_ProfileScreen_tempText, LV_PART_MAIN| LV_STATE_DEFAULT, LV_STYLE_BG_OPA, _ui_theme_alpha_Dark);
...
ui_ProfileScreen_tempTarget= NULL;
ui_ProfileScreen_tempGauge= NULL;
ui_ProfileScreen_ImgButton1= NULL;
ui_ProfileScreen_contentPanel= NULL;
ui_ProfileScreen_mainLabel= NULL;
ui_ProfileScreen_profileChoices= NULL;
ui_ProfileScreen_tempText= NULL;
